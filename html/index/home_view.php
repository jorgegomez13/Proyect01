        ...
        <div class="container">
            <div class="row">
                <div class="col col-md-10 offset-md-1 col-lg-8 offset-lg-2">
                        <h1 class="wow fadeIn">Bienvenido <strong>KC</strong></h1>
                        <div class="description wow fadeInLeft">
                                <p>Esta pagina sigue en Construccion<a href="http://kiracorporation.com/"><strong>KC</strong></a>.
                                </p>
                        </div>
                        <div class="buttons wow fadeInUp">							
                                                <a class="btn btn-primary btn-customized scroll-link" href="#section-1" role="button">
                                                        <i class="fas fa-book-open"></i> Leer Mas
                                                </a>
                                                <a class="btn btn-primary btn-customized-2 scroll-link" href="#section-3" role="button">
                                                        <i class="fas fa-pencil-alt"></i> Otros Proyectos
                                                </a>
                                        </div>
                </div>
            </div>
			        ...
			        <div class="container">
			            ...
			            <div class="row">
			                ...
			                <div class="col-4 section-2-box wow fadeInUp">
		                    	<img src="views/img/about-us.jpg" alt="about-us">
			                </div>
			            </div>
			        </div>
		        </div>
			        ...
			        <div class="container">
			            ...
			            <div class="row">
		                	<div class="col-md-4 section-5-box wow fadeInUp">
		                		<div class="section-5-box-image"><img src="views/img/portfolio/1.jpg" alt="portfolio-1"></div>
		                    ...
		                    <div class="col-md-4 section-5-box wow fadeInDown">
			                	<div class="section-5-box-image"><img src="views/img/portfolio/2.jpg" alt="portfolio-2"></div>
		                    ...
		                    <div class="col-md-4 section-5-box wow fadeInUp">
			                	<div class="section-5-box-image"><img src="views/img/portfolio/3.jpg" alt="portfolio-3"></div>
			        ...
			        <div class="container">
			            <div class="row">
			                <div class="col section-6 section-description wow fadeIn">
			                    <h2>Contacto</h2>
			                    <div class="divider-1 wow fadeInUp"><span></span></div>
			                    <p>Envianos un correo, nosotros te escuchamos!</p>
			                </div>
			            </div>
			            <div class="row">
		                	<div class="col-md-6 section-6-box wow fadeInUp">
		                    	...
		                    	<div class="section-6-form">
		                    		<form role="form" action="views/contact.php" method="post">
